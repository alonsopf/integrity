...
- (void)setupWithType:(NSUInteger)type {
    ...
    if (self.storyboard) {
        ...
        self.leftViewBackgroundColor = [UIColor colorWithRed:0.15 green:0.15 blue:0.15 alpha:0.95];
        self.rootViewCoverColorForLeftView = [UIColor colorWithRed:0.15 green:0.15 blue:0.15 alpha:0.05];
    ...
    UIColor *greenCoverColor = [UIColor colorWithRed:0.15 green:0.15 blue:0.15 alpha:0.3];
    ...
    switch (self.type) {
        ...
        case 6: {
            ...
            self.leftViewBackgroundColor = [UIColor colorWithRed:0.15 green:0.15 blue:0.15 alpha:0.05];
            self.rootViewCoverColorForLeftView = greenCoverColor;
        ...
        case 11: {
            ...
            self.leftViewBackgroundColor = [UIColor colorWithRed:0.15 green:0.15 blue:0.15 alpha:1.0];
            ...
            self.rootViewCoverColorForLeftView = [UIColor colorWithRed:0.15 green:0.15 blue:0.15 alpha:0.3];
            self.rootViewCoverBlurEffectForLeftView = [UIBlurEffect effectWithStyle:regularStyle];
